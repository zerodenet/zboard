...
var preReleaseReconciledTables = []string{"announcements", "announcement_reads", "node_config_publishes", "network_entries", "node_group_network_entries", "node_proxy_pools"}
