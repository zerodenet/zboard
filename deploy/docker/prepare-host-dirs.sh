...
plugin_dir=$(resolve_path "${ZBOARD_PLUGIN_HOST_DIR:-./plugins}")
...
printf 'Prepared plugin directory: %s (writable persistent mount)\n' "$plugin_dir"
...
printf 'Back up the database, plugin, managed rule, and Zero event spool directories together.\n'
