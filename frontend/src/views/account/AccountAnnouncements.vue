<template>
  <section class="standard-page account-announcements">
    ...
    <section v-if="featured.length" class="featured-board" aria-label="重点公告">
