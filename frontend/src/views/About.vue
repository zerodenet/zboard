...
const shortCommit = computed(() => {
  const value = String(info.value?.commit || '').trim()
...
function formatBuildTime(value: string) {
  if (!value || value === '1970-01-01T00:00:00Z') return '本地开发构建'
