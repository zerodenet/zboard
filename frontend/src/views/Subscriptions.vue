...
function resetPolicyName(value: number) { return ({ 0: '未设置（不重置）', 1: '每月 1 日', 2: '按购买日每月', 3: '每年 1 月 1 日', 4: '按购买日每年', 5: '不重置' } as Record<number, string>)[value] || formatUnknownValue('重置策略', value) }
