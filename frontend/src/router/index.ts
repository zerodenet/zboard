...
export const routes: RouteRecordRaw[] = [
  ...
  { path: '/register', component: () => import('../views/Register.vue'), meta: { requiresGuest: true, requiresRegistration: true, title: '注册', layout: 'auth' } },
  {
    ...
    children: [
      ...
      { path: 'integrations', component: () => import('../views/account/AccountIntegrations.vue'), meta: { title: '外部集成' } },
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'network-entries', redirect: { path: '/admin/protocols', query: { kind: 'forward' } } },
      ...
      { path: 'runtime-jobs', component: () => import('../views/RuntimeJobs.vue'), meta: { title: '后台任务', section: '系统运营' } },
